...
const LoadshModuleReplacemntPlugin = require('lodash-webpack-plugin');

const year = new Date().getFullYear();
const COPYRIGHT = 'Copyright ' + year + ' World Food Programme - All rights reserved.';
...
const PUBLIC_HOST = process.env.DOCKER_HOST ? 'me.wfppal.org' : 'localhost';
  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        title: 'Monitroing and Evalution Palestine Database (MEPD)',
      ...
      isProd &&
        new FaviconsWebpackPlugin({
          ...
          favicons: {
            appName: 'MEPD',
            appShortName: 'MEPD',
            appDescription: 'Monitroing and Evalution Palestine Database',
            developerName: 'MEPD',
            background: '#ffffff',
            theme_color: '#007DBC',
            display: 'standalone',
